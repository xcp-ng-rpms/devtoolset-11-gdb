%global package_speccommit 16fe4cd87e6e5826e18eb2f9bb5574e7aaf44c23
%global usver 10.2
%global xsver 5
...
Source0: gdb-10.2.tar.xz
Patch0: gdb-6.3-rh-testversion-20041202.patch
Patch1: gdb-6.3-gstack-20050411.patch
Patch2: gdb-6.3-test-dtorfix-20050121.patch
Patch3: gdb-6.3-test-movedir-20050125.patch
Patch4: gdb-6.3-threaded-watchpoints2-20050225.patch
Patch5: gdb-6.3-inferior-notification-20050721.patch
...
Patch9: gdb-6.5-BEA-testsuite.patch
Patch10: gdb-6.5-last-address-space-byte-test.patch
Patch11: gdb-6.5-readline-long-line-crash-test.patch
Patch12: gdb-6.5-bz218379-solib-trampoline-lookup-lock-fix.patch
...
Patch25: gdb-6.7-charsign-test.patch
Patch26: gdb-6.7-ppc-clobbered-registers-O2-test.patch
...
Patch35: gdb-6.8-bz466901-backtrace-full-prelinked.patch
...
Patch66: gdb-container-rh-pkg.patch
Patch67: gdb-rhbz1325795-framefilters-test.patch
Patch68: gdb-libexec-add-index.patch
Patch69: gdb-rhbz1398387-tab-crash-test.patch
Patch70: gdb-rhbz1553104-s390x-arch12-test.patch
Patch71: gdb-rhbz1905996-fix-off-by-one-error-in-ada_fold_name.patch
Patch72: gdb-rhbz1912985-libstdc++-assert.patch
Patch73: gdb-rhbz1909902-frame_id_p-assert-1.patch
Patch74: gdb-rhbz1909902-frame_id_p-assert-2.patch
Patch75: gdb-rhbz1941080-fix-gdbserver-hang.patch
Patch76: testing-custom-inputrc.patch
Patch77: gdb-rhbz1931344-bfd_seek-elf_read_notes.patch
Patch78: gdb-rhbz1964167-fortran-clean-up-array-expression-evaluation.patch
Patch79: gdb-rhbz1964167-move-fortran-expr-handling.patch
Patch80: gdb-rhbz1964167-fortran-whitespace_array.patch
Patch81: gdb-rhbz1964167-convert-enum-range_type.patch
Patch82: gdb-rhbz1964167-fortran-range_type-to-range_flag.patch
Patch83: gdb-rhbz1964167-fortran-array-strides-in-expressions.patch
Patch84: gdb-rhbz1964167-fortran-array-slices-at-prompt.patch
Patch85: gdb-rhbz1964167-fortran-fix-type-format-mismatch-in-f-lang.c.patch
Patch86: gdb-rhbz1898252-loadable-section-outside-ELF-segments.patch
Patch87: gdb-rhbz1903375-s390x-store-on-condition.patch
Patch88: gdb-gdb27743-psymtab-imported-unit.patch
Patch89: gdb-dont-overwrite-fsgsbase-m32.patch
Patch90: gdb-testsuite26997-fix-array-slices-m32.patch
Patch91: gdb-flexible-array-member-expected-pattern.patch
Patch92: gdb-dts-use-decltype.patch
...
Recommends: devtoolset-11-gcc-gdb-plugin%{?_isa}
...
#=fedora
Source5: gdb-libstdc++-v3-python-8.1.1-20180626.tar.xz
...
%global have_debuginfod 0
%global use_scl_for_debuginfod 0
#BuildRequires: devtoolset-11-elfutils-debuginfod-client-devel
%endif
%endif
...
BuildRequires: devtoolset-11-gcc-c++ devtoolset-11-gcc-gfortran

%if 0%{!?rhel:1} || 0%{?rhel} < 8
BuildRequires: gcc-objc
%endif
%if 0%{!?rhel:1} || 0%{?rhel} > 7 || 0%{?scl:1}
BuildRequires: devtoolset-11-gcc-gdb-plugin%{?_isa}
%endif
%if 0%{?rhel:1} && 0%{?rhel} < 7
...
# Exception for RHEL<=7
#%ifarch s390x
#BuildRequires: devtoolset-11-valgrind%{bits_local}
#%if 0%{!?rhel:1} || 0%{?rhel} > 7
#BuildRequires: devtoolset-11-valgrind%{bits_local} valgrind%{bits_other}
#%endif
#%else
#BuildRequires: devtoolset-11-valgrind%{bits_local} valgrind%{bits_other}
#%endif
